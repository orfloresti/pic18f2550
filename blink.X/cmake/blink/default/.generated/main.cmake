...
add_executable(blink_default_image_hAKDysJn ${blink_default_library_list})

set_target_properties(blink_default_image_hAKDysJn PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${blink_default_output_dir})
set_target_properties(blink_default_image_hAKDysJn PROPERTIES OUTPUT_NAME "default")
set_target_properties(blink_default_image_hAKDysJn PROPERTIES SUFFIX ".elf")

target_link_libraries(blink_default_image_hAKDysJn PRIVATE ${blink_default_default_XC8_FILE_TYPE_link})


# Add the link options from the rule file.
blink_default_link_rule(blink_default_image_hAKDysJn)
